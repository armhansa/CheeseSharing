...
<html>
    ...
    <body>
        ...
        <div class="sheet">
            <div class="detail">
                <h3 style="margin-left: 10px">เส้นและจุด วิชาศิลปะ</h3>
                <p style="margin-left: 10px">ผู้โพส : win thanawin</p>
            </div>
            <div class="open-file">
                วว/ดด/ปป
                <button class="open-btn btn btn-warning" type="submit" style="margin-left: 20px; width: 70px;">เปิด</button>
            </div>
        </div>

        <div class="sheet">
            <div class="detail">
                <h3 style="margin-left: 10px">ปติมากรรม วิชาศิลปะ</h3>
                <p style="margin-left: 10px">ผู้โพส : danaya opor</p>
            </div>
            <div class="open-file">
                วว/ดด/ปป
                <button class="open-btn btn btn-warning" type="submit" style="margin-left: 20px; width: 70px;">เปิด</button>
        ...
        <div class="sheet">
            <div class="detail">
                <h3 style="margin-left: 10px">วาดภาพนู้ด วิชาศิลปะ</h3>
                <p style="margin-left: 10px">ผู้โพส : hansa yim</p>
            </div>
            <div class="open-file">
                วว/ดด/ปป
                <button class="open-btn btn btn-warning" type="submit" style="margin-left: 20px; width: 70px;">เปิด</button>
