            ...
            <div class="col-10" style="background-color: #edb91f; margin: auto;">
                <form action="EditProfileServlet" method="post" var="list" item="query_profile.rows">
                    <div style="padding: 10%">
                        ...
                        <input type="text" name="firstName" value="<%= user.getFirstName()%>" class="col-12 form-control margin_form" required><br>
                        <input type="text" name="lastName" value="<%= user.getLastName()%>"  class="col-12 form-control margin_form" required><br>
                        <input type="password" name="oldPassword" placeholder="Old Password" class="col-12 form-control margin_form" pattern=".{6,}" title="กรุณากรอกรหัสผ่านมากกว่า 6 ตัว" required><br>
                        <input type="password" name="newPassword" placeholder="New Password (ไม่จำเป็น)" class="col-12 form-control margin_form" pattern=".{6,}" title="กรุณากรอกรหัสผ่านมากกว่า 6 ตัว"><br>
                        <input type="Email" name="email" value="<%= user.getEmail() %>" class="col-12 form-control margin_form" disabled><br>
                        <select style="height: 35px" class="col-12 form-control margin_form" name="faculty" required>
